...
XPCOMUtils.defineLazyServiceGetter(this, "imgTools", "@mozilla.org/image/tools;1", "imgITools");
XPCOMUtils.defineLazyServiceGetter(this, "taskbar", "@mozilla.org/windows-taskbar;1", "nsIWinTaskbar");
XPCOMUtils.defineLazyServiceGetter(this, "acctMgr", "@mozilla.org/messenger/account-manager;1", "nsIMsgAccountManager");
XPCOMUtils.defineLazyServiceGetter(this, "mailSession", "@mozilla.org/messenger/services/session;1", "nsIMsgMailSession");
...
function addDigitToImageArray(imgData, imgDataStride, digit, digitStride, x, y)
{
 ...
 */
function createBadgeIcon(msgCount)
{
   ...
   let iconImage = imgTools.decodeImage(imgEncoder, "image/png");
...
function getUnreadCountForAllAccounts()
{
...
function getUnreadCountForAccountRootFolder(rootFolder)
{
   var totalCount = 0;
...
function getActiveWindowOverlayIconController()
{
   ...
   return taskbar.getOverlayIconController(docshell);
}
...
function queueOverlayIconUpdate()
{
   if (gActiveWindow)
